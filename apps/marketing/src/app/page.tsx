                    ...
                    <div className="space-y-10">
                        <div>
                            ...
                            <p className="text-base md:text-lg text-slate-400 leading-relaxed">
                                92% of Hikari users feel more in control of their time and money within the first week. Our method is built on clarity and intentionality. <Link href="/help/article/ultimate-guide-hikari-method" className="text-primary-400 font-semibold hover:underline">Read the Guide &rarr;</Link>
                            </p>
                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <Link href="/method" className="inline-flex items-center gap-2 text-primary-400 font-bold hover:text-primary-300 transition-colors ml-5 pt-4">
