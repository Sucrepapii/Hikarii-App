            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 mb-20">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-slate-400">
                            <li><Link href="/help/article/ultimate-guide-hikari-method" className="text-primary-400 font-semibold hover:text-primary-300 transition-colors">The Ultimate Guide</Link></li>
                            ...
                            <li><Link href="/feedback" className="hover:text-primary-400 transition-colors">Feedback</Link></li>
                        </ul>
                    </div>
