        ...
        <nav className="fixed top-0 w-full z-50 bg-[#080910]/80 backdrop-blur-xl border-b border-white/[0.06]">
            ...
            {isMenuOpen && (
                <div className="md:hidden absolute top-[68px] left-0 w-full bg-[#0D0F1A] border-b border-white/5 py-4 px-6 flex flex-col gap-4 shadow-2xl animate-fade-in-up">
                    <Link to="/pricing" className="text-lg font-medium text-slate-300 py-2 border-b border-white/5" onClick={() => setIsMenuOpen(false)}>
                        Pricing
                    </Link>
                    ...
                    {!isAuthenticated && (
                        <Link to="/login" className="text-lg font-medium text-slate-300 py-2" onClick={() => setIsMenuOpen(false)}>
                            Login
                        </Link>
                    )}
                    <Button
