...
const priorityColors = {
    [TaskPriority.LOW]: 'bg-accent-500',
                        ...
                        >
                            ...
                            {showSparkles && (
                                <>
                                    ...
                                    <Sparkles className="sparkle-burst text-accent-400 bottom-[-8px] left-[5px]" size={14} style={{ animationDelay: '0.2s' }} />
                                </>
                            )}
                            <div className={clsx(
                ...
                <div className="mt-auto pt-3 border-t border-slate-100 dark:border-slate-700/50 flex items-end justify-between gap-2">
                    ...
                    <div className="flex gap-1 shrink-0">
                        <button
                            ...
                            className="p-2 text-slate-400 hover:text-accent-500 hover:bg-accent-50 dark:hover:bg-accent-500/10 rounded-lg transition-colors"
                            title="Smart Split"
                        >
