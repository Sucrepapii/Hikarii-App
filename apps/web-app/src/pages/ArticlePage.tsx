        ...
        <div className="min-h-screen bg-[#080910] font-sans text-slate-100 flex flex-col deep-dark">
            ...
            <main className="flex-grow pt-32 pb-20 px-6 max-w-3xl mx-auto w-full">
                <div className="mb-8">
                    ...
                    <div className="flex items-center gap-1 bg-primary-500/10 text-primary-400 px-3 py-1 rounded-full">
            ...
            <article className="prose prose-invert prose-lg max-w-none prose-headings:font-display prose-headings:font-bold prose-headings:text-white prose-p:text-slate-300 prose-a:text-primary-400">
