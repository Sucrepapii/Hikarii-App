            ...
            <div className="container mx-auto px-6 py-20 max-w-6xl relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-32">
                    ...
                    <section className="bg-[#0D0F1A] p-12 rounded-[3rem] border border-white/[0.06] shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="space-y-6">
                            <div>
                                <h4 className="text-indigo-400 font-bold text-sm uppercase tracking-widest mb-2">Runtime Protection</h4>
                            ...
                            <div>
                                <h4 className="text-indigo-400 font-bold text-sm uppercase tracking-widest mb-2">Access Lifecycle</h4>
