                ...
                <div className="space-y-12">
                    <section className="bg-[#0D0F1A] p-10 md:p-16 rounded-[3rem] border border-white/[0.06] shadow-2xl relative overflow-hidden group">
                        ...
                        <p className="text-slate-400 leading-relaxed text-lg mb-6">
                            These Terms of Service ("Agreement") constitute a legally binding contract between you ("User," "you," or "your") and Hikarii World Ltd ("Company," "we," "us," or "our"). This Agreement governs your access to and use of the Hikarii application, website, and associated services (collectively, the "Service").
                        </p>
                    ...
                    <section className="bg-[#0D0F1A] p-10 md:p-16 rounded-[3rem] border border-white/[0.06] shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="space-y-6 text-slate-400 leading-relaxed text-lg">
                            <p>The Service, including its "look and feel," proprietary algorithms, source code, and branding, is the exclusive property of Hikarii and is protected by international copyright, trademark, and patent laws.</p>
                    ...
                    <section className="bg-[#0D0F1A] p-10 md:p-16 rounded-[3rem] border border-white/[0.06] shadow-2xl relative overflow-hidden group">
                        ...
                        <p className="text-slate-400 leading-relaxed text-lg mb-6">
                            TO THE MAXIMUM EXTENT PERMITTED BY LAW, Hikarii AND ITS AFFILIATES SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING LOSS OF PROFITS, DATA, OR GOODWILL, ARISING OUT OF YOUR USE OF THE SERVICE.
                        </p>
                    ...
                    <section className="bg-[#0D0F1A] p-10 md:p-16 rounded-[3rem] border border-white/[0.06] shadow-2xl relative overflow-hidden group">
                        ...
                        <p className="text-slate-400 leading-relaxed text-lg">
                            You agree to indemnify, defend, and hold harmless Hikarii and its officers from and against any claims, damages, liabilities, and expenses arising out of your breach of this Agreement, your use of the Service, or your violation of any third-party rights.
                        </p>
                    </section>
