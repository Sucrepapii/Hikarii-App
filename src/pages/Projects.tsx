                            ...
                            <Card key={project.id} className="relative overflow-hidden group hover:shadow-lg transition-all border border-transparent hover:border-primary-200 dark:hover:border-primary-800">
                                ...
                                <div className="relative flex items-center justify-between mb-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        {project.isShared && (
                                            <span className="px-2 py-1 rounded-md text-xs font-bold bg-primary-100 dark:bg-primary-500/10 text-primary-600 dark:text-primary-400 flex items-center gap-1">
                                        ...
                                        {(project.userId === user?.id || project.memberRole === 'CAN_EDIT') && (
                                            <Tooltip content="Invite Collaborator">
                                                <Button
                                                    ...
                                                    className="p-2 bg-primary-500/10 hover:bg-primary-500/20 text-primary-600 dark:text-primary-400 rounded-lg transition-smooth"
                                                >
                                            ...
                                            <>
                                                <Link to={`/projects/edit/${project.id}`}>
                                                    <Tooltip content="Edit Project">
                                                        <Button variant="ghost" size="sm" className="p-2 bg-primary-500/10 hover:bg-primary-500/20 text-primary-600 dark:text-primary-400 rounded-lg transition-smooth">
