                    ...
                    <div className="h-64 flex items-center justify-center relative">
                        ...
                        <div className="absolute flex flex-col items-center">
                            <span className="text-3xl font-bold text-slate-800 dark:text-white">
                                {data.stats.totalUsers > 0 ? ((data.stats.proUsers / data.stats.totalUsers) * 100).toFixed(1) : 0}%
                            </span>
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                            {[
                                ...
                                { cat: 'Activity', metric: 'Tasks per User', val: data.stats.totalUsers > 0 ? (data.stats.totalTasks / data.stats.totalUsers).toFixed(1) : 0, note: 'Average lifetime' },
                                { cat: 'Intelligence', metric: 'AI Split Adoption', val: data.stats.totalTasks > 0 ? `${((data.stats.totalAiSplits / data.stats.totalTasks) * 100).toFixed(1)}%` : '0%', note: 'Tasks utilizing smart splitting' },
