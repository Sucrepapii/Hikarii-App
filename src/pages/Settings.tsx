...
import { Download, Database, Shield, DollarSign, CreditCard, Calendar as CalendarIcon, User, Link2 } from 'lucide-react';
...
export const Settings: React.FC = () => {
    ...
    const tabs = [
        ...
        { id: 'currency', label: 'Currency Preferences', icon: DollarSign },
        ...
        <div className="animate-fade-in max-w-6xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex-1 space-y-6">
                    {/* Profile Information (includes Subscription) */}
                    {activeTab === 'profile' && (
                        <>
                            <Card>
