          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="text-sm font-semibold text-slate-800 dark:text-white truncate">
                {displayName}{isCurrentUser && <span className="ml-1 text-xs text-indigo-500">(you)</span>}
              </div>
            ...
            {isOwner && member.status === 'ACCEPTED' && (
              <div className="relative">
                <select
                  ...
                  className="text-xs bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/10 rounded-lg px-2 py-1 text-slate-700 dark:text-slate-300 focus:outline-none focus:ring-1 focus:ring-indigo-500 pr-6 appearance-none"
                >
