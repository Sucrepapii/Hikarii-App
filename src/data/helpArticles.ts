...
export const helpArticles: Article[] = [
  ...
  },
  {
    ...
    content: `
        ...
        <p>Clarity isn't just for individuals. Teams often suffer from "Shadow Work"—tasks that happen without budget approval, or spending that happens without a clear task attached. By using <strong>Rule 5: Scale with Collaboration</strong>, you bring your entire team into the Hikari ecosystem.</p>
