...
export const createBudget = async (
  ...
  try {
    ...
    const budget = await Budget.findOneAndUpdate(
      { userId: req.userId, category: req.body.category },
      { ...req.body, userId: req.userId, spent },
...
export const createExpense = async (
  ...
  try {
    ...
    await Budget.findOneAndUpdate(
      { userId: req.userId, category: expense.category },
...
export const updateExpense = async (
  ...
  try {
    ...
    if (
      ...
      await Budget.findOneAndUpdate(
        { userId: req.userId, category: oldExpense.category },
